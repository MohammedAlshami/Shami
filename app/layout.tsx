...
export default function RootLayout({
  ...
  return (
    <html lang="en" className="dark">
      <body
        className={`${myFont.className} bg-neutral-800 flex flex-col justify-between overflow-x-hidden`}
      >
        <div className="w-92 absolute top-10 left-16 transform -translate-x-1/2 z-[10000] cursor-pointer">
          <div className="font-sans font-bold  text-3xl flex flex-col space-y-4">
            <a href="/" className="w-full flex bg-white p-1 size-14 rounded-full fill-yellow-300 transition-transform duration-300 hover:-translate-y-1 hover:bg-yellow-300 hover:fill-gray-100">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className="p-1 ">
