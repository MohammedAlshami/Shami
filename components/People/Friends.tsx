        ...
        <div className="mt-12">
          <ul className="grid gap-8 lg:grid-cols-2">
            {team.map((item, idx) => (
              <li
                key={idx}
                className="gap-8 sm:flex bg-neutral-800/40 border border-neutral-800/80 border-4 p-8 rounded-xl hover:-translate-y-6 transition-transform duration-500 ease-in-out hover:shadow-md hover:shadow-neutral-800/80"
              >
